...
import DisplayNft from "../Arena/DisplayChar";
        ...
        .catch((error) => {
          ...
          (async () => {
            ...
            proposals.forEach(async (proposal) => {
              ...
              this.setState(prevState => ({
                proposals: [...prevState.proposals, {proposalNum: proposal.key, proposal: string, votes: parsedVotes, contracts: proposalContracts, sat: sat, endRound: proposal.value}]
              }))
            })
      ...
      async apply(proposalNum) {
        ...
        async vote(proposalNum) {
          ...
          const appArgs = []
            ...
            this.state.walletAssets.forEach((dao) => {
              if (foreignAssets.length < 4) {
                foreignAssets.push(dao)
              }
            })
