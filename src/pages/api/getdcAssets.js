...
async function getdcAssets(req, res) {
 ...
 const token = {
  ...
  if (req.body.nextToken) {
      response = await indexerClient.lookupAccountCreatedAssets("AL6F3TFPSZPF3BSVUFDNOLMEKUCJJAA7GZ5GF3DN3Q4IVJVNUFK76PQFNE").nextToken(req.body.nextToken).limit(1000).do();
  }
  else {
