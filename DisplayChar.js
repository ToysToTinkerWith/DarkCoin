...
export default function DisplayChar(props) {
    ...
    const joinBrawl = async () => {
        ...
        let txn = algosdk.makeApplicationNoOpTxn(activeAccount.address, params, props.contracts.brawl, appArgs, accounts, foreignApps, foreignAssets, undefined, undefined, undefined, boxes);
        ...
        props.setMessage("Transaction Confirmed, Get ready to rumble!")
        ...
        if (nft) {
            if (props.select) {
            ...
            else if (props.brawler && charObject) {
                ...
                return (
                    <div onMouseOver={() => setHover(true)} onMouseLeave={() => setHover(false)} style={{position: "absolute", left: (-(Math.sin(radians)*props.width/3) + (props.width/2.2)), top: (-(Math.cos(radians)*props.height/3) + (props.height/2))}}>
                        ...
                        {props.char && props.moveSelect != null ?
                        <Button variant="contained" color="secondary"  style={{display: "flex", margin: "auto"}} onClick={() => props.attack(props.nftId)} >
                        ...
                        <Card style={Math.sin(radians) < 0 ? {zIndex: 10, position: "absolute", display: "grid", right: 0, backgroundColor: "black", minWidth: 200, border: "1px solid white"} : {zIndex: 10, position: "absolute", display: "grid", left: 0, backgroundColor: "black", minWidth: 200, border: "1px solid white"}}>
                            ...
                            <Grid container style={{padding: 20}}> 
                                <Grid item xs={12}>
                                    ...
                                    {healthAdj == 0 ?
                                        <Typography color="secondary" align="center" variant="subtitle1"> {charObject.currentHealth} </Typography>
                                        :
                                        healthAdj < 0 ?
                                        <div>
                                        <Typography color="secondary" align="center" variant="subtitle1"> {charObject.currentHealth} </Typography>
                                ...
                                <Grid item xs={6}>
                                    ...
                                    {speedAdj == 0 ?
                                        <Typography color="secondary" align="center" variant="subtitle1"> {charObject.speed} </Typography>
                                        :
                                        speedAdj < 0 ?
                                        <Typography color="secondary" align="center" variant="subtitle1" style={{color: "#F8575A"}}> {charObject.speed + speedAdj} </Typography>
                                        :
                                        <Typography color="secondary" align="center" variant="subtitle1" style={{color: "#4EC83E"}}> {charObject.speed + speedAdj} </Typography>
                                    }                                
                                </Grid>
                                <Grid item xs={6}>
                                    ...
                                    {resistAdj == 0 ?
                                        <Typography color="secondary" align="center" variant="subtitle1"> {charObject.resist} </Typography>
                                        :
                                        resistAdj < 0 ?
                                        <Typography color="secondary" align="center" variant="subtitle1" style={{color: "#F8575A"}}> {charObject.resist + resistAdj} </Typography>
                                        :
                                        <Typography color="secondary" align="center" variant="subtitle1" style={{color: "#4EC83E"}}> {charObject.resist + resistAdj} </Typography>
                                    }                                
                                </Grid>
                            </Grid>
                            ...
                            <Grid container style={{padding: 20}}>
                                <Grid item xs={4} sm={4} md={4}>
                                    ...
                                    {strengthAdj == 0 ?
                                        <Typography color="secondary" align="center" variant="subtitle1"> {charObject.strength} </Typography>
                                        :
                                        strengthAdj < 0 ?
                                        <Typography color="secondary" align="center" variant="subtitle1" style={{color: "#F8575A"}}> {charObject.strength + strengthAdj} </Typography>
                                        :
                                        <Typography color="secondary" align="center" variant="subtitle1" style={{color: "#4EC83E"}}> {charObject.strength+ strengthAdj} </Typography>
                                    }                                
                                    </Grid>
                                <Grid item xs={4} sm={4} md={4}>
                                    ...
                                    {dexterityAdj == 0 ?
                                        <Typography color="secondary" align="center" variant="subtitle1"> {charObject.dexterity} </Typography>
                                        :
                                        dexterityAdj < 0 ?
                                        <Typography color="secondary" align="center" variant="subtitle1" style={{color: "#F8575A"}}> {charObject.dexterity + dexterityAdj} </Typography>
                                        :
                                        <Typography color="secondary" align="center" variant="subtitle1" style={{color: "#4EC83E"}}> {charObject.dexterity + dexterityAdj} </Typography>
                                    }                                
                                    </Grid>
                                <Grid item xs={4} sm={4} md={4}>
                                    ...
                                    {intelligenceAdj == 0 ?
                                        <Typography color="secondary" align="center" variant="subtitle1"> {charObject.intelligence} </Typography>
                                        :
                                        intelligenceAdj < 0 ?
                                        <Typography color="secondary" align="center" variant="subtitle1" style={{color: "#F8575A"}}> {charObject.intelligence + intelligenceAdj} </Typography>
                                        :
                                        <Typography color="secondary" align="center" variant="subtitle1" style={{color: "#4EC83E"}}> {charObject.intelligence + intelligenceAdj} </Typography>
                                    }                                
                                    </Grid>
                            </Grid>
                                        ...
                                        <div style={{border: "1px solid white", margin: 20, borderRadius: 15}}>
                                            ...
                                            <Grid container style={{marginTop: 10, marginBottom: 10, padding: 10}}>
                                                <Grid item xs={6}>
                                                    ...
                                                    {move.type.substring(0,5) == "melee" ?
                                                        strengthAdj == 0 ?
                                                        <Typography color="secondary" align="center" variant="subtitle1"> {move.power + charObject.strength} </Typography>
                                                        :
                                                        strengthAdj < 0 ?
                                                        <Typography color="secondary" align="center" variant="subtitle1" style={{color: "#F8575A"}}> {move.power + charObject.strength + strengthAdj} </Typography>
                                                        :
                                                        <Typography color="secondary" align="center" variant="subtitle1" style={{color: "#4EC83E"}}> {move.power + charObject.strength + strengthAdj} </Typography>
                                                        :
                                                        null
                                                    }
                                                    {move.type.substring(0,6) == "ranged" ?
                                                        dexterityAdj == 0 ?
                                                        <Typography color="secondary" align="center" variant="subtitle1"> {move.power + charObject.dexterity} </Typography>
                                                        :
                                                        dexterityAdj < 0 ?
                                                        <Typography color="secondary" align="center" variant="subtitle1" style={{color: "#F8575A"}}> {move.power + charObject.dexterity + dexterityAdj} </Typography>
                                                        :
                                                        <Typography color="secondary" align="center" variant="subtitle1" style={{color: "#4EC83E"}}> {move.power + charObject.dexterity + dexterityAdj} </Typography>
                                                        :
                                                        null
                                                    }
                                                    {move.type.substring(0,5) == "magic" ?
                                                        intelligenceAdj == 0 ?
                                                        <Typography color="secondary" align="center" variant="subtitle1"> {move.power + charObject.intelligence} </Typography>
                                                        :
                                                        intelligenceAdj < 0 ?
                                                        <Typography color="secondary" align="center" variant="subtitle1" style={{color: "#F8575A"}}> {move.power + charObject.intelligence + intelligenceAdj} </Typography>
                                                        :
                                                        <Typography color="secondary" align="center" variant="subtitle1" style={{color: "#4EC83E"}}> {move.power + charObject.intelligence + intelligenceAdj} </Typography>
                                                        :
                                                        null
                                                    }
