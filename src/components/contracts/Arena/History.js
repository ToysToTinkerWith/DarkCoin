                            ...
                            <div key={index}>
                                ...
                                <Grid container>
                                    <Grid item xs={12} sm={5} style={{display: "flex", margin: "auto", width: "50%", maxWidth: 300}} >
                                        <DisplayChar contract={this.state.contract} nftId={char1} setNft={(nftId) => this.setState({charSelect: nftId})} />
                                    </Grid>
                                    <Grid item xs={12} sm={2}>
                                        <Typography color="secondary" align="center" variant="h6" style={{padding: 20}}> vs </Typography>
                                    </Grid>
                                    <Grid item xs={12} sm={5} style={{display: "flex", margin: "auto", width: "50%", maxWidth: 300}}>
                                        <DisplayChar contract={this.state.contract} nftId={char2} setNft={(nftId) => this.setState({charSelect: nftId})} />
                                    </Grid>
                                </Grid>
