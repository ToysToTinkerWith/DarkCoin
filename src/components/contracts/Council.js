...
import Propose from "./Council/Propose"
import Vote from "./Council/Vote"
            ...
            <div>
              <br />
                  <Grid container >
                    ...
                    <Grid item xs={12} sm={4}>
                    <Button className={muisty.mixerbtn} style={{backgroundColor: this.state.place == "amend" ? "#FFFFFF" : "#000000", border: "1px solid white", display: "flex", margin: "auto"}} onClick={() => this.state.place == "amend" ? this.setState({place: ""}) : this.setState({place: "amend"})}>
                        <Typography color="secondary" variant="h6" style={{color: this.state.place == "amend" ? "#000000" : "#FFFFFF"}}> Amend </Typography>
                    </Button>
                    </Grid>
                  </Grid>
