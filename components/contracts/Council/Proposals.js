    ...
    async componentDidMount() {
      ...
      const client = new algosdk.Algodv2(token, 'https://mainnet-algorand.api.purestake.io/ps2', '')
        ...
        let ftxn2 = algosdk.makeAssetTransferTxnWithSuggestedParams(
          ...
          undefined,
          undefined,
          String(this.state[proposalNum]).length * 50000000, 
          undefined,
          1088771340,
          params
        );
        ...
        const appArgs = []
          ...
          if (false) {
            ...
            try {
              ...
              this.props.sendDiscordMessage("Arena/Proposals", props.activeAddress, error)
            }
 ...
 const token = {
        ...
        for (let i = 0; i < this.state.walletAssets.length; i++) {
          ...
          if (i < 16) {
            ...
            let foreignAssets = [1088771340, this.state.walletAssets[i]]
        ...
        const client = new algosdk.Algodv2(token, 'https://mainnet-algorand.api.purestake.io/ps2', '')
            ...
            for (let i = 0; i < this.state.walletAssets.length; i++) {
              ...
              if (i < 16) {
                ...
                let foreignAssets = [this.state.walletAssets[i], 1088771340]
                ...
                const appArgs = []
                  ...
                  if (false) {
                    ...
                    try {
                      ...
                      this.props.sendDiscordMessage("Council/Proposals", props.activeAddress, error)
                    }
                      ...
                      return (
                        <div key={index} style={{borderTop: "1px solid white", padding: 20}}>
                          ...
                          <Typography color="secondary" variant="h6" > Offer {proposal.contracts[0].appNum} </Typography>
                            ...
                            <br />
                            <Typography color="secondary" variant="h6" align="center" >  {Number(contractApp.cost).toLocaleString("en-US")} <img src="invDC.svg" style={{display: "inline", width: 30, paddingTop: 20}} /></Typography>
                            <br />
                        ...
                        <br />
                        <Typography color="secondary" variant="h6" align="center" > This contract will recieve {Number(median / 100 * contractApp.cost).toLocaleString("en-US")} <img src="invDC.svg" style={{display: "inline", width: 30, paddingTop: 20}} /></Typography>
                        <br />
