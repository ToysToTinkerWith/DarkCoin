                    ...
                    if (atob(kv.key) == "assetId") {
                        ...
                        if (charName && charStats) {
                            ...
                            if (this.props.wallet == "pera") {
                                ...
                                this.props.sendDiscordMessage("Arena/Battle", props.activeAddress, error)
                                }
            ...
            if (this.props.zoom) {
                ...
                return (
                    <div style={{border: "1px solid white"}}>
                        ...
                        <Typography color="secondary" align="center" variant="h6"> {Number(this.props.wager / 1000000).toLocaleString("en-US")} <img style={{width: 40, paddingRight: 20}} src="./DarkCoinLogo.png"/> </Typography>
                        <br />
                        ...
                        <Button variant="contained" color="secondary" style={{display: "flex", margin: "auto"}} onClick={() => this.joinBattle()}>
                            <Typography color="primary" variant="h6" align="center"> Fight {Number(this.props.wager / 1000000).toLocaleString("en-US")} </Typography>
