...
export default function Swap(props) {
    ...
    React.useEffect(() => {
        ...
        if (selWarrior) {
            return (
                <Swapper refetchData={() => refetchData()} nftId={selWarrior} traits={traits} ownTraits={ownTraits} contracts={props.contracts} zoom={true} setSelWarrior={setSelWarrior} setMessage={props.setMessage} sendErrorMessage={props.sendErrorMessage}/>
            )
        }
        else {
            return (
